...
public class Matrix {
   ...
   Matrix(int n) {
      if(n < 1)
         throw new RuntimeException("Matrix Error: Matrix() called with negative column count.");
      row = new List[n + 1];
      for(int i = 1; i < (n + 1); ++i) {
         row[i] = new List();
      }
   ...
   // Helper for adding/subtracting of two Lists
